...
var EVENTS = [
    ...
    new Event("Lizardo v. Denny's Inc.", 1998, 2, "Denny's is sued by the AALDEF because of the refusal to serve Asian American students. Those same students were beaten up in the parking lot by a group of white people. Despite being recent, it has highlighted the need for anti-descrimination training.", null),
    ...
    new Event("\"National Origins\"", 1965, 6, "National origins is removed from the immigration quote basis, placing all countries on equal footing; this also assisted the prevention of descrimination in immigration based on country of origin.", null),
